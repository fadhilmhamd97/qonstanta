...
const BookModuleSubs = ({props}) => {
  ...
  const redirectTo = e => {
        ...
        return(
            <Redirect
                to={{
                 pathname: `/learn/videos/module/${e}`
                }}
            />
        )
  }
            ...
            <div key={i} className="col-md-4 col-sm-12" style={{marginTop: 2 + 'em'}}>
                <Card className={classes.root}>
                    ...
                    <CardContent>
                        ...
                        <ProgressBar now={progressBar.split('%')[0]} />
                    <Typography style={{textAlign: 'right'}} variant="caption" component="p" display="block" gutterBottom>
